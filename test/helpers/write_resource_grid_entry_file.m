% WRITE_RESOURCE_GRID_ENTRY_FILE:
...
%         * double matrix INDICES     - 3xN matrix with the indices associated to each data
%           sample - each entry comprises [antenna port index,OFDM sybmol index, RE index]

function write_resource_grid_entry_file(filename,data,indices)
