...
classdef CheckPUCCHF3Conformance < matlab.unittest.TestCase
    ...
    properties (TestParameter)
        ...
        %   Defines, for each test, the subcarrier spacing, test number, number of receive antennas, DM-RS configuration, bandwidth, and target SNR.
    ...
    methods (Test, TestTags = {'conformance'})
        function checkPUCCHF3BLER(obj, TestConfig)
            ...
            %   information, if present. The payload is of 16 UCI bits, with no CSI Part 2.
