...
function fullBlocks = listFullBlocks()
    fullBlocks = { ...
        ... 'phy/upper/channel_coding/ldpc/ldpc_encoder', ...
        ... 'phy/upper/channel_coding/ldpc/ldpc_rate_matcher', ...
        ... 'phy/upper/channel_coding/ldpc/ldpc_segmenter', ...
        'phy/upper/channel_modulation/modulation_mapper', ...
        'phy/upper/channel_processors/pbch_encoder', ...
        'phy/upper/channel_processors/pbch_modulator', ...
        'phy/upper/channel_processors/pdcch_encoder', ...
        'phy/upper/channel_processors/pdcch_modulator', ...
        'phy/upper/channel_processors/pdsch_encoder', ...
        'phy/upper/channel_processors/pdsch_modulator', ...
        'phy/upper/signal_processors/dmrs_pbch_processor', ...
        'phy/upper/signal_processors/dmrs_pdcch_processor', ...
        'phy/upper/signal_processors/dmrs_pdsch_processor', ...
        };
end
